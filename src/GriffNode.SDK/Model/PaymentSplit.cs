...
namespace GriffNode.SDK.Model
{
    ...
    public partial class PaymentSplit : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="txid">On-chain transaction hash (blockchain id, NOT the GriffNode transaction_id)..</param>
        ...
        /// </summary>
        /// <value>On-chain transaction hash (blockchain id, NOT the GriffNode transaction_id).</value>
